...
class LoyaltyProgramPolicy
{
    ...
    {
        return $user->hasPermissionTo('view-loyalty-program');
    }
    ...
    {
        return $user->hasPermissionTo('create-loyalty-program');
    }
    ...
    {
        return $user->hasPermissionTo('update-loyalty-program');
    }
    ...
    {
        return $user->hasPermissionTo('delete-loyalty-program');
    }
    ...
    {
        return $user->hasPermissionTo('restore-loyalty-program');
    }
    ...
    {
        return $user->hasPermissionTo('force-delete-loyalty-program');
    }
}
