...
class MarketingCampaignPolicy
{
    ...
    {
        return $user->hasPermissionTo('view-marketing-campaign');
    }
    ...
    {
        return $user->hasPermissionTo('create-marketing-campaign');
    }
    ...
    {
        return $user->hasPermissionTo('update-marketing-campaign');
    }
    ...
    {
        return $user->hasPermissionTo('delete-marketing-campaign');
    }
    ...
    {
        return $user->hasPermissionTo('restore-marketing-campaign');
    }
    ...
    {
        return $user->hasPermissionTo('force-delete-marketing-campaign');
    }
}
