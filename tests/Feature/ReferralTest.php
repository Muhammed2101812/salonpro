...
class ReferralTest extends TestCase
{
    ...
    public function test_can_create_referral(): void
    {
        ...
        $response = $this->actingAs($this->user, 'sanctum')
            ->postJson('/api/v1/referrals', $data);
    ...
    public function test_can_show_referral(): void
    {
    ...
    public function test_can_update_referral(): void
    {
        ...
        $response = $this->actingAs($this->user, 'sanctum')
            ->putJson("/api/v1/referrals/{$referral->id}", $updateData);
    ...
    public function test_can_delete_referral(): void
    {
        ...
        $response = $this->actingAs($this->user, 'sanctum')
            ->deleteJson("/api/v1/referrals/{$referral->id}");
