...
class PurchaseOrderTest extends TestCase
{
    ...
    public function test_can_list_purchaseOrders(): void
    {
    ...
    public function test_can_create_purchaseOrder(): void
    {
        ...
        $response = $this->actingAs($this->user, 'sanctum')
            ->postJson('/api/v1/purchase-orders', $data);
        ...
        $this->assertDatabaseHas('purchase-orders', [
            'id' => $response->json('data.id')
        ]);
    }

    public function test_can_show_purchaseOrder(): void
    {
    ...
    public function test_can_update_purchaseOrder(): void
    {
        ...
        $response = $this->actingAs($this->user, 'sanctum')
            ->putJson("/api/v1/purchase-orders/{$purchaseOrder->id}", $updateData);
    ...
    public function test_can_delete_purchaseOrder(): void
    {
        ...
        $this->assertSoftDeleted('purchase-orders', [
            'id' => $purchaseOrder->id
        ]);
    }
