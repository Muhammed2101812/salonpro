...
class AuditLogTest extends TestCase
{
    ...
    public function test_can_list_auditLogs(): void
    {
    ...
    public function test_can_create_auditLog(): void
    {
        ...
        $response = $this->actingAs($this->user, 'sanctum')
            ->postJson('/api/v1/audit-logs', $data);
        ...
        $this->assertDatabaseHas('audit-logs', [
            'id' => $response->json('data.id')
        ]);
    }

    public function test_can_show_auditLog(): void
    {
    ...
    public function test_can_update_auditLog(): void
    {
        ...
        $response = $this->actingAs($this->user, 'sanctum')
            ->putJson("/api/v1/audit-logs/{$auditLog->id}", $updateData);
    ...
    public function test_can_delete_auditLog(): void
    {
        ...
        $this->assertSoftDeleted('audit-logs', [
            'id' => $auditLog->id
        ]);
    }
