<template>
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div>
        <h1 class="text-3xl font-bold text-gray-900">SurveyResponses</h1>
        <p class="mt-2 text-sm text-gray-600">Manage your surveyresponses</p>
      </div>
      <button
    ...
    <FormModal
      v-model="showModal"
      :title="editingItem ? 'Edit SurveyResponse' : 'Create SurveyResponse'"
      @save="saveItem"
    >
...
import { useSurveyResponseStore } from '@/stores/surveyresponse'
import FormModal from '@/components/FormModal.vue'

const store = useSurveyResponseStore()
const items = ref([])
const meta = ref({})
const search = ref('')
