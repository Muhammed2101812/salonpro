<template>
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div>
        <h1 class="text-3xl font-bold text-gray-900">ProductVariants</h1>
        <p class="mt-2 text-sm text-gray-600">Manage your productvariants</p>
      </div>
      <button
    ...
    <FormModal
      v-model="showModal"
      :title="editingItem ? 'Edit ProductVariant' : 'Create ProductVariant'"
      @save="saveItem"
    >
