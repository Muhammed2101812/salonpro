<template>
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div>
        <h1 class="text-3xl font-bold text-gray-900">CustomerRfmAnalyses</h1>
        <p class="mt-2 text-sm text-gray-600">Manage your customerrfmanalyses</p>
      </div>
      <button
    ...
    <FormModal
      v-model="showModal"
      :title="editingItem ? 'Edit CustomerRfmAnalysis' : 'Create CustomerRfmAnalysis'"
      @save="saveItem"
    >
...
import { useCustomerRfmAnalysisStore } from '@/stores/customerrfmanalysis'
import FormModal from '@/components/FormModal.vue'

const store = useCustomerRfmAnalysisStore()
const items = ref([])
const meta = ref({})
const search = ref('')
