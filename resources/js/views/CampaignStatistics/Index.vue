<template>
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div>
        <h1 class="text-3xl font-bold text-gray-900">CampaignStatistics</h1>
        <p class="mt-2 text-sm text-gray-600">Manage your campaignstatistics</p>
      </div>
      <button
    ...
    <FormModal
      v-model="showModal"
      :title="editingItem ? 'Edit CampaignStatistic' : 'Create CampaignStatistic'"
      @save="saveItem"
    >
...
import { useCampaignStatisticStore } from '@/stores/campaignstatistic'
import FormModal from '@/components/FormModal.vue'

const store = useCampaignStatisticStore()
const items = ref([])
const meta = ref({})
const search = ref('')
