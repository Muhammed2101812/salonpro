<template>
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div>
        <h1 class="text-3xl font-bold text-gray-900">StockAlerts</h1>
        <p class="mt-2 text-sm text-gray-600">Manage your stockalerts</p>
      </div>
      <button
    ...
    <FormModal
      v-model="showModal"
      :title="editingItem ? 'Edit StockAlert' : 'Create StockAlert'"
      @save="saveItem"
    >
