<template>
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div>
        <h1 class="text-3xl font-bold text-gray-900">BudgetItems</h1>
        <p class="mt-2 text-sm text-gray-600">Manage your budgetitems</p>
      </div>
      <button
    ...
    <FormModal
      v-model="showModal"
      :title="editingItem ? 'Edit BudgetItem' : 'Create BudgetItem'"
      @save="saveItem"
    >
...
import { useBudgetItemStore } from '@/stores/budgetitem'
import FormModal from '@/components/FormModal.vue'

const store = useBudgetItemStore()
const items = ref([])
const meta = ref({})
const search = ref('')
