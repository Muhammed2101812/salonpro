<template>
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div>
        <h1 class="text-3xl font-bold text-gray-900">CustomFieldValues</h1>
        <p class="mt-2 text-sm text-gray-600">Manage your customfieldvalues</p>
      </div>
      <button
    ...
    <FormModal
      v-model="showModal"
      :title="editingItem ? 'Edit CustomFieldValue' : 'Create CustomFieldValue'"
      @save="saveItem"
    >
...
import { useCustomFieldValueStore } from '@/stores/customfieldvalue'
import FormModal from '@/components/FormModal.vue'

const store = useCustomFieldValueStore()
const items = ref([])
const meta = ref({})
const search = ref('')
