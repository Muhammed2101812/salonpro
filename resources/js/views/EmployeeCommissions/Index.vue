<template>
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div>
        <h1 class="text-3xl font-bold text-gray-900">EmployeeCommissions</h1>
        <p class="mt-2 text-sm text-gray-600">Manage your employeecommissions</p>
      </div>
      <button
    ...
    <FormModal
      v-model="showModal"
      :title="editingItem ? 'Edit EmployeeCommission' : 'Create EmployeeCommission'"
      @save="saveItem"
    >
