<template>
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div>
        <h1 class="text-3xl font-bold text-gray-900">ProductCategoryHierarchies</h1>
        <p class="mt-2 text-sm text-gray-600">Manage your productcategoryhierarchies</p>
      </div>
      <button
    ...
    <FormModal
      v-model="showModal"
      :title="editingItem ? 'Edit ProductCategoryHierarchy' : 'Create ProductCategoryHierarchy'"
      @save="saveItem"
    >
...
import { useProductCategoryHierarchyStore } from '@/stores/productcategoryhierarchy'
import FormModal from '@/components/FormModal.vue'

const store = useProductCategoryHierarchyStore()
const items = ref([])
const meta = ref({})
const search = ref('')
