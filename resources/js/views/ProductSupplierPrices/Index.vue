<template>
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div>
        <h1 class="text-3xl font-bold text-gray-900">ProductSupplierPrices</h1>
        <p class="mt-2 text-sm text-gray-600">Manage your productsupplierprices</p>
      </div>
      <button
    ...
    <FormModal
      v-model="showModal"
      :title="editingItem ? 'Edit ProductSupplierPrice' : 'Create ProductSupplierPrice'"
      @save="saveItem"
    >
...
import { useProductSupplierPriceStore } from '@/stores/productsupplierprice'
import FormModal from '@/components/FormModal.vue'

const store = useProductSupplierPriceStore()
const items = ref([])
const meta = ref({})
const search = ref('')
