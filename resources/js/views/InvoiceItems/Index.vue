<template>
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div>
        <h1 class="text-3xl font-bold text-gray-900">InvoiceItems</h1>
        <p class="mt-2 text-sm text-gray-600">Manage your invoiceitems</p>
      </div>
      <button
    ...
    <FormModal
      v-model="showModal"
      :title="editingItem ? 'Edit InvoiceItem' : 'Create InvoiceItem'"
      @save="saveItem"
    >
...
import { useInvoiceItemStore } from '@/stores/invoiceitem'
import FormModal from '@/components/FormModal.vue'

const store = useInvoiceItemStore()
const items = ref([])
const meta = ref({})
const search = ref('')
