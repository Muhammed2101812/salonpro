<template>
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div>
        <h1 class="text-3xl font-bold text-gray-900">ServicePriceHistories</h1>
        <p class="mt-2 text-sm text-gray-600">Manage your servicepricehistories</p>
      </div>
      <button
    ...
    <FormModal
      v-model="showModal"
      :title="editingItem ? 'Edit ServicePriceHistory' : 'Create ServicePriceHistory'"
      @save="saveItem"
    >
...
import { useServicePriceHistoryStore } from '@/stores/servicepricehistory'
import FormModal from '@/components/FormModal.vue'

const store = useServicePriceHistoryStore()
const items = ref([])
const meta = ref({})
const search = ref('')
