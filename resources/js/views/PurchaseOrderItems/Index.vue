<template>
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div>
        <h1 class="text-3xl font-bold text-gray-900">PurchaseOrderItems</h1>
        <p class="mt-2 text-sm text-gray-600">Manage your purchaseorderitems</p>
      </div>
      <button
    ...
    <FormModal
      v-model="showModal"
      :title="editingItem ? 'Edit PurchaseOrderItem' : 'Create PurchaseOrderItem'"
      @save="saveItem"
    >
...
import { usePurchaseOrderItemStore } from '@/stores/purchaseorderitem'
import FormModal from '@/components/FormModal.vue'

const store = usePurchaseOrderItemStore()
const items = ref([])
const meta = ref({})
const search = ref('')
