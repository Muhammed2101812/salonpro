<template>
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div>
        <h1 class="text-3xl font-bold text-gray-900">DocumentTemplates</h1>
        <p class="mt-2 text-sm text-gray-600">Manage your documenttemplates</p>
      </div>
      <button
    ...
    <FormModal
      v-model="showModal"
      :title="editingItem ? 'Edit DocumentTemplate' : 'Create DocumentTemplate'"
      @save="saveItem"
    >
