<template>
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div>
        <h1 class="text-3xl font-bold text-gray-900">OauthTokens</h1>
        <p class="mt-2 text-sm text-gray-600">Manage your oauthtokens</p>
      </div>
      <button
    ...
    <FormModal
      v-model="showModal"
      :title="editingItem ? 'Edit OauthToken' : 'Create OauthToken'"
      @save="saveItem"
    >
...
import { useOauthTokenStore } from '@/stores/oauthtoken'
import FormModal from '@/components/FormModal.vue'

const store = useOauthTokenStore()
const items = ref([])
const meta = ref({})
const search = ref('')
