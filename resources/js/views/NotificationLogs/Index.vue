<template>
  <div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
      <div>
        <h1 class="text-3xl font-bold text-gray-900">NotificationLogs</h1>
        <p class="mt-2 text-sm text-gray-600">Manage your notificationlogs</p>
      </div>
      <button
    ...
    <FormModal
      v-model="showModal"
      :title="editingItem ? 'Edit NotificationLog' : 'Create NotificationLog'"
      @save="saveItem"
    >
